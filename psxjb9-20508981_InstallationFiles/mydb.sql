...
INSERT INTO Fines (Fine_ID, Fine_Amount, Fine_Points, Incident_ID)
VALUES (1, 2000, 6, 3),
       (2, 50, 0, 2),
       (3, 500, 3, 4);
...
VALUES (1, 15, 4, '2017-12-01', '40mph in a 30 limit', 1),
...
INSERT INTO Offence (Offence_ID, Offence_description, Offence_maxFine, Offence_maxPoints)
VALUES (1, 'Speeding', 1000, 3),
...
INSERT INTO Ownership (People_ID, Vehicle_ID)
VALUES (3, 12),
       (8, 20),
       (4, 15),
       (4, 13),
...
INSERT INTO People (People_ID, People_name, People_address, People_licence)
VALUES (1, 'James Smith', '23 Barnsdale Road, Leicester', 'SMITH92LDOFJJ829'),
...
INSERT INTO Vehicle (Vehicle_ID, Vehicle_type, Vehicle_colour, Vehicle_licence)
VALUES (12, 'Ford Fiesta', 'Blue', 'LB15AJL'),
...
ALTER TABLE Incident
MODIFY COLUMN Incident_Report varchar(200);

INSERT INTO Users(ID, Username, Password) VALUES (3, "daniels", "copper99");